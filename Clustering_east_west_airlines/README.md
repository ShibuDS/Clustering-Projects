...
cc1_miles, cc2_miles, cc3_miles: Miles earned using frequent flyer credit cards (1: Under 5,000, 5: Over 50,000).
Bonus_miles: Non-flight bonus transactions.
...
Days_since_enrolled: Days since joining the program.
Award: Indicator of whether a free flight was awarded (0 or 1). 
